function H=RSOSHFFGN_SC(L,time,th0,R_M)
% This is a function for calculating the height result of the long-range spatial correlation RSOS model. The output is the height value at a certain position on the interface. 
...
% Output: The height value at a certain position on the interface of the long-range spatial correlation RSOS model.
