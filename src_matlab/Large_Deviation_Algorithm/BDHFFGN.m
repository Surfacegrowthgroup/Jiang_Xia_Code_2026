function H=BDHFFGN(L,time,th0,R_M)
% This is a function for calculating the high-level result of the long-term time correlation BD model, and the output is the height value at a certain position on the interface. 
...
% Output: The height value at a certain position on the interface of the long-term time correlation BD model.
N0=40;
