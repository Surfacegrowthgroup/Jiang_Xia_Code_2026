function res_H=RSOSFFGN_SC_SK(L,time,count,th0,s)
%The spatial correlation RSOS model is used to predict the quantity of S&K, and the relationship diagram of S&K's change over time is utilized. 
% Input: L base size, time simulation time, count number of ensemble repetitions, th0 spatial correlation index, s is the upper limit of the nearest height difference (all are constant 1). 
